...
export default function ProfileSettingSection() {
  return (
    <div className="flex h-[912px] items-center rounded-[10px] bg-[url(/images/img_group_54.png)] bg-cover bg-no-repeat px-[30px] py-[42px] md:h-auto md:py-5 sm:p-5">
      <div className="mx-auto mb-6 flex w-full max-w-[1380px] flex-col items-start">
        ...
        <Input
          ...
          className="mt-11 w-[42%] rounded-lg px-8"
        />
        
        <div className="mt-[50px] flex flex-col items-start gap-3.5 self-stretch">
          <Text as="p" className="ml-2.5 text-[16px] font-normal md:ml-0">
            Email Address
          </Text>
          <Input
            shape="round"
            ...
            className="w-[42%] rounded-lg px-8 sm:px-5"
          />
        </div>
        ...
        <div className="mt-[30px] flex flex-col items-start gap-1.5 self-stretch">
          ...
          <Input shape="round" name="state_one" placeholder="State" className="w-[42%] rounded-lg px-8 sm:px-5" />
        </div>
        ...
        <div className="mt-[30px] flex flex-col items-start gap-1.5 self-stretch">
          ...
          <Input shape="round" name="city" placeholder="City" className="w-[42%] rounded-lg px-8 sm:px-5" />
        </div>
      </div>
    </div>
  );
